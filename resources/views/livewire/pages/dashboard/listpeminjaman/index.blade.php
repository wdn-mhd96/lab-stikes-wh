                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-300  text-sm ">
                        ...
                        <td class="px-4 py-2 flex justify-center gap-2 items-center">
                            <button wire:click="confirmDelete({{ $pinjam->id }})"class="bg-red-600 text-white hover:bg-red-700 rounded-md py-1 px-3 text-sm">Hapus</button>
                            <button wire:click="editInventory({{ $pinjam->id }})" class="bg-emerald-600 text-white hover:bg-emerald-700 rounded-md py-1 px-3 text-sm">Edit</button>
                        </td>
                    </tr>
                    @endforeach
